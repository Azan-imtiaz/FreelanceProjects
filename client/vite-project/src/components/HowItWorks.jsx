        ...
        <div className="flex flex-col lg:flex-row lg:space-x-8">
          ...
          <div className="flex-1 bg-white p-6 rounded-lg shadow-lg border-2 border-purple-300 mb-4 lg:mb-0 lg:relative lg:before:content-[''] lg:before:absolute lg:before:-left-8 lg:before:top-1/2 lg:before:-translate-y-1/2 lg:before:w-8 lg:before:h-8 lg:before:bg-purple-300 lg:before:rounded-full lg:before:border-2 lg:before:border-purple-700 lg:before:transform lg:before:scale-105">
            <div className="relative z-20">
              <h3 className="text-xl font-semibold text-purple-800 mb-2">Step 1</h3>
              <p className="text-gray-700">Enter all the required data in the search field and then choose the desired vehicle.</p>
            </div>
          </div>
          ...
          <div className="flex-1 bg-white p-6 rounded-lg shadow-lg border-2 border-purple-300 mb-4 lg:mb-0 lg:relative lg:before:content-[''] lg:before:absolute lg:before:-left-8 lg:before:top-1/2 lg:before:-translate-y-1/2 lg:before:w-8 lg:before:h-8 lg:before:bg-purple-300 lg:before:rounded-full lg:before:border-2 lg:before:border-purple-700 lg:before:transform lg:before:scale-105">
            <div className="relative z-20">
              <h3 className="text-xl font-semibold text-purple-800 mb-2">Step 2</h3>
              <p className="text-gray-700">Enter the details of the lead passenger, add extras if you wish. Proceed to payment and receive your voucher.</p>
            </div>
          </div>
          ...
          <div className="flex-1 bg-white p-6 rounded-lg shadow-lg border-2 border-purple-300 mb-4 lg:mb-0 lg:relative lg:before:content-[''] lg:before:absolute lg:before:-left-8 lg:before:top-1/2 lg:before:-translate-y-1/2 lg:before:w-8 lg:before:h-8 lg:before:bg-purple-300 lg:before:rounded-full lg:before:border-2 lg:before:border-purple-700 lg:before:transform lg:before:scale-105">
            <div className="relative z-20">
              <h3 className="text-xl font-semibold text-purple-800 mb-2">Step 3</h3>
              <p className="text-gray-700">You will receive your driver's details 6 hours prior to pickup, and he will be waiting for you on-site with a Name Sign.</p>
            </div>
          </div>
          ...
          <div className="flex-1 bg-white p-6 rounded-lg shadow-lg mb-4 lg:mb-0 lg:relative lg:before:content-[''] lg:before:absolute lg:before:-left-8 lg:before:top-1/2 lg:before:-translate-y-1/2 lg:before:w-8 lg:before:h-8 lg:before:bg-blue-500 lg:before:rounded-full lg:before:border-2 lg:before:border-blue-700 lg:before:transform lg:before:scale-105">
            <div className="relative z-20 flex items-center">
              ...
              <div>
                <h3 className="text-xl font-semibold text-purple-800">Completed</h3>
                <p className="text-gray-700">Your booking process is completed. Thank you for choosing our service!</p>
              </div>
            </div>
          </div>
        </div>
